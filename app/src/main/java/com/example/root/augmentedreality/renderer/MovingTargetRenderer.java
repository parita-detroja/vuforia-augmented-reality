...
import com.example.root.augmentedreality.activity.MovingTargetActivity;
import com.example.root.augmentedreality.utility.BowlAndSpoonObject;
import com.example.root.augmentedreality.utility.CubeObject;
 ...
 */
public class MovingTargetRenderer implements GLSurfaceView.Renderer, AppRendererControl
{
    private static final String LOGTAG = "MultiTargetRenderer";

    private ApplicationSession vuforiaAppSession;
    private MovingTargetActivity mMovingTargetActivity;
    ...
    public MovingTargetRenderer(MovingTargetActivity activity, ApplicationSession session)
    {
        mMovingTargetActivity = activity;
        vuforiaAppSession = session;

        // SampleAppRenderer used to encapsulate the use of RenderingPrimitives setting
        // the device mode AR/VR and stereo mode
        mSampleAppRenderer = new AppRenderer(this, mMovingTargetActivity, Device.MODE.MODE_AR, false, 0.010f, 5f);
    }

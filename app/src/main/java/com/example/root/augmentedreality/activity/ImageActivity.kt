...
import com.example.root.augmentedreality.renderer.ImageRenderer
...
class ImageActivity : Activity(), ApplicationControl {
    ...
    // Our renderer:
    private var mRenderer: ImageRenderer? = null
    ...
    {
        if (ContextCompat.checkSelfPermission(this@ImageActivity, Manifest.permission.CAMERA)
                != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(this@ImageActivity,
    ...
    private fun showErrorDialog() {
        ...
        mDialog = AlertDialog.Builder(this@ImageActivity).create()
    ...
    private fun initApplicationAR() {
        ...
        mRenderer = ImageRenderer(this, vuforiaAppSession!!)
    ...
    companion object {
        private val LOGTAG = "ImageActivity"
    }
